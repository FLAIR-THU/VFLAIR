...
python main_pipeline.py --configs main_passive/mnist_test_attack_nodefense --gpu 7
...
python main_pipeline.py --configs main_passive/mnist_test_attack_mid --gpu 7
