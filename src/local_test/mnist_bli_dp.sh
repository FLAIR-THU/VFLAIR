...
sed -i 's/"name": "GaussianDP"/"name": "LaplaceDP"/g' ./configs/test/mnist_bli_dp_configs.json
sed -i 's/"lr": 0.050/"lr": 0.001/g' ./configs/test/mnist_bli_dp_configs.json
sed -i 's/"apply_trainable_layer": 1/"apply_trainable_layer": 0/g' ./configs/test/mnist_bli_dp_configs.json
...
sed -i 's/"lr": 0.001/"lr": 0.050/g' ./configs/test/mnist_bli_dp_configs.json
sed -i 's/"apply_trainable_layer": 0/"apply_trainable_layer": 1/g' ./configs/test/mnist_bli_dp_configs.json
...
sed -i 's/"name": "LaplaceDP"/"name": "GaussianDP"/g' ./configs/test/mnist_bli_dp_configs.json
# ###### make sure starts with non-trainable head ######
sed -i 's/"lr": 0.050/"lr": 0.001/g' ./configs/test/mnist_bli_dp_configs.json
sed -i 's/"apply_trainable_layer": 1/"apply_trainable_layer": 0/g' ./configs/test/mnist_bli_dp_configs.json
sed -i 's/"global_model": "ClassificationModelHostTrainableHead"/"global_model": "ClassificationModelHostHead"/g' ./configs/test/mnist_bli_dp_configs.json
...
# srun --gres=gpu:a100-80G:1 --time=1-00:00:00 --mem=20000 bash ./local_test/mnist_bli_dp.sh