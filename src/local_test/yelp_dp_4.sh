...
for seed in {60,61,62,63,64,65}
    ...
    # 60
    sed -i 's/"epsilon": 50/"epsilon": 60/g' ./configs/yelp_dp_4.json
    # python main_pipeline_llm_4.py --seed $seed --configs yelp_dp_4

    # 70
    sed -i 's/"epsilon": 60/"epsilon": 70/g' ./configs/yelp_dp_4.json
    python main_pipeline_llm_4.py --seed $seed --configs yelp_dp_4

    # 80
    sed -i 's/"epsilon": 70/"epsilon": 80/g' ./configs/yelp_dp_4.json
    python main_pipeline_llm_4.py --seed $seed --configs yelp_dp_4

    # 90
    sed -i 's/"epsilon": 80/"epsilon": 90/g' ./configs/yelp_dp_4.json
    # python main_pipeline_llm_4.py --seed $seed --configs yelp_dp_4
