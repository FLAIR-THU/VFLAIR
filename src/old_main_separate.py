...
'''
[1]untargeted backdoor attack:  do not access function: evaluate_attack()
Key metrics include:
- MissingFeature: party missing_rate
- NoisyLabel: party noise_rate
Key Metrics: main_task_acc

[2]targeted backdoor attack:  do not access function: evaluate_attack()
    args.apply_backdoor
Key metrics include:
- MissingFeature: main_task_acc
- NoisyLabel: main_task_acc

[3]label inference attack:  access function: evaluate_attack()
    args.apply_attack = True
- BatchLabelReconstruction: main_task_acc label_inference_acc
- NormbasedScoring: main_task_acc label_inference_acc
- DirectionbasedScoring: main_task_acc label_inference_acc
Key Metrics: main_task_acc label_inference_acc

'''
EMBEDED_ATTACK = ["MissingFeature","NoisyLabel",""]
