...
class MainTaskVFL_LLM(object):
    ...
    def pred_transmit(self, use_cache=False, count_time=False):
        ...
        for ik in range(self.k - 1):
            ...
            result_dict = self.parties[ik].give_pred_dev(use_cache=use_cache)  # , _input_shape
    ...
    def vfl_forward(self, **kwargs):
        ...
        self.parties[0].obtain_local_data_dev(**kwargs)

        self.parties[1].obtain_local_data_dev(input_ids = None, 
