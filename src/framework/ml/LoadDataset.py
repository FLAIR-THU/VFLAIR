...
def load_dataset_per_party_llm(args):
    ...
    if args.dataset == 'news20':
        ...
        text_path = 'D:\\work\\tools\\datasets\\' + 'CoLA/raw/in_domain_train.tsv'
        ...
        text_path = 'D:\\work\\tools\\datasets\\' + 'CoLA/raw/in_domain_dev.tsv'
        df = pd.read_csv(text_path , delimiter='\t', header=None, names=['sentence_source', 'label', 'label_notes', 'sentence'])
        sentences = df.sentence.values 
        labels = df.label.values
        ...
        ### train ###
        text_path =  'D:\\work\\tools\\datasets\\'  + 'MMLU\\dev\\'
        ...
        ### test ###
        text_path =  'D:\\work\\tools\\datasets\\'  + 'MMLU\\test\\'
        ...
        ## train
        data_file = 'D:\\work\\projects\\PlatForm\\src\\dataset\\train-v1.1.json'
        # data_file = '/dev/data/sunl0/datasets/squad/train-v1.1.json'
        ...
        data_file = 'D:\\work\\projects\\PlatForm\\src\\dataset\\dev-v1.1.json'
        # data_file = '/dev/data/sunl0/datasets/squad/dev-v1.1.json'
